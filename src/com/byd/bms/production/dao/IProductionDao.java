...
public interface IProductionDao {
	...
	public List<Map<String, Object>> getLineInventoryMatList(Map<String,Object> conditionMap);
	public int getLineInventoryMatListCount(Map<String,Object> conditionMap);
