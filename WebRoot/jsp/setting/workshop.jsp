...
<meta charset="utf-8" />
<title>MES Settings Workshop</title>
...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div id="form" class="well form-search">
						<table>
							<tr>
								<td>Workshop：</td>
								<td><input type="text" style="height: 30px;" class="input-medium revise" placeholder="Please enter the workshop name..." value="" id="search_workshop" /></td>
				...
				<div id="dialog-add" class="hide">
					<form id="addForm" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="addFactoryName">*&nbsp;Workshop Name</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="Workshop Name..." id="addWorkshopName" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="addWorkshopCode">*&nbsp;Workshop Code</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="Workshop Code..." id="addWorkshopCode" />
							</div>
						</div>
				...
				<div id="dialog-edit" class="hide">
					<form id="editForm" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="editWorkshopName">*&nbsp;Workshop Name</label>
							<div class="col-sm-9">
								<input type="hidden" id="editId" />
								<input type="text" class="input-medium" placeholder="Workshop Name..." id="editWorkshopName" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="editWorkshopCode">*&nbsp;Workshop Code</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="Workshop Code..." id="editWorkshopCode" />
							</div>
						</div>
	...
	<script src="../js/setting/workshop.js"></script>
</body>
