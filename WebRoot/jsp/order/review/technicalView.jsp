			...
			<div class="page-content">
				...
				<table id="tableData" class="table table-striped table-bordered table-hover dataTable no-footer"
					...
					<tr role="row" class="odd">
						<td>&nbsp;技术协议/配置表：</td>
						<td>&nbsp;${item['configTable'] }</td>
						<td>&nbsp;型材清单：</td>
						<td>&nbsp;${item['proximatematter'] }</td>
					</tr>
					<tr role="row" class="even">
						<td>&nbsp;数模评审：</td>
						<td>&nbsp;${item['modeljudging'] }</td>
						<td>&nbsp;图纸受控前评审：</td>
						<td>&nbsp;${item['drawingearlierjudging'] }</td>
					</tr>
					<tr role="row" class="odd">
						<td>&nbsp;采购明细：</td>
...
<!-- 							</td> -->
<!-- 							<td><td class="td_table_2" colspan="3"> -->
<%-- 						        &nbsp;${item['technology.operator'] } --%>
<!-- 						</td> -->
