					...
					<form action="<%=basePath%>/snaker/flow/process" method="post">
						...
						<table id="tableData" class="table table-striped table-bordered table-hover dataTable no-footer"
							...
							<tr role="row" class="odd">
							    <td>&nbsp;资料需求节点：</td>
								<td>
									<input type="radio" value="OK" name="S_qualityNode"/>&nbsp;&nbsp;OK &nbsp;&nbsp;&nbsp;
							        <input type="radio" value="NG" name="S_qualityNode"/>&nbsp;&nbsp;NG
								</td>
							</tr>
							<tr role="row" class="even">
								<td>&nbsp;其他：</td>
								<td colspan=2>
								<textarea id="qualityInfo" name="S_qualityInfo" style="width: 580px;" placeholder="..." rows="3"></textarea>
								</td>
							</tr>
							<tr role="row" class="odd">
								<td></td>
								<td align="right">
									<input type="hidden" id="quality_operator" name="S_quality.operator" value="${operator }" />
						            <input type="hidden" id="factory_operator" name="S_factory.operator" value="${nextOperator }" />
            ...
            $(function(){
            	$("#btnSave").click(function(){
            		...
            		$.ajax({
            			...
            			dataType: "json",
            			data: {
            				"qualityNode" : $('input:radio[name="S_qualityNode"]:checked').val(),
            				"qualityInfo":$("#qualityInfo").val(),
