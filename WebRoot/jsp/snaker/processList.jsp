...
<html>
	...
	<form id="mainForm" action="${ctx}/snaker/process/list" method="get">
		...
		<table align="center" border="0" cellpadding="0"
			...
			<tr>
				<td align="left">
					<input type='button' onclick="addNew('designer')" class='button_70px' value='设计'/>
					<input type='button' onclick="addNew('deploy')" class='button_70px' value='部署'/>
					<input type='button' onclick="addNew('init')" class='button_70px' value='初始化'/>
