										...
										<tr>
											...
											<td>
											    <select id="status" class="input-small" style='width:80px;height: 30px;'>
													...
													<option value="2" selected="selected">已驳回</option>
													<option value="3">已锁定</option>
											    </select>
											</td>
											<td>
											  &nbsp;<input type="button" class="btn btn-sm btn-primary" id="btnQuery" value="查询" style="margin-left: 2px;"></input>
											  &nbsp;<input type="button" class="btn btn-sm btn-info" id="btnModify" value="修改" style="margin-left: 2px;"></input>
<!-- 											  &nbsp;<input type="button" class="btn btn-sm btn-warning" id="btnDelete" value="删除" style="margin-left: 2px;"></input> -->
											</td>
		...
		<script src="../js/production/waitWorkTimeMod.js"></script>
</body>
