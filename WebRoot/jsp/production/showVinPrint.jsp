...
<html lang="zh-CN">
						...
						<table>
							<tr>
								...
								<td>
								    ...
								    <input id="btnSave" type="button" class="btn btn-sm btn-success" value="保存" style="margin-left: 2px;"></input>
								</td>
							</tr>
						</table>	
					</div>
	...
	<script type="text/javascript" src="../js/production/showVinPrint.js"></script>
</html>
