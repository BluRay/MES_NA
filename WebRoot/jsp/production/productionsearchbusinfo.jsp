						...
						<div class="tab-content" id="tab-content">
							<div id="div_1" class="tab-pane fade in active">
								<table id="table01" style="text-align:center;table-layout:fixed;font-size:12px;width:850px" class="table table-bordered table-striped">
									<tr>
										<td width="105px">Project No.：</td><td id="tab01_order_no"></td><td width="105px">Bus No.：</td><td id="tab01_bus_number"></td><td width="105px">VIN：</td><td id="tab01_vin"></td>
									</tr>
									<tr>
										<td>Plant：</td><td id="tab01_factory_name"></td><td>Customer：</td><td id="tab01_customer"></td><td>Production Date：</td><td id="tab01_production_date"></td>
									</tr>
									
<!-- 									<tr> -->
<!-- 										<td>车辆颜色：</td><td id="tab01_bus_color"></td><td>座位数量：</td><td id="tab01_bus_seats"></td> -->
<!-- 									</tr> -->
									<tr>
										<td>Status：</td><td id="tab01_production_status"></td><td>Welding Online Date：</td><td id="tab01_welding_online_date"></td><td>Welding Offline Date：</td><td id="tab01_welding_offline_date"></td>
									</tr>
									<tr>
									...
									<tr>
										<td>Testing Date</td><td id="tab01_testline_online_date"></td><td>Outgoing Date：</td><td id="tab01_outgoing_date"></td><td></td>
									</tr>				
								</table>
							</div>
