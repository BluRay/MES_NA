...
<html lang="en">
		...
		<div class="main-container notPrintable" id="main-container">
			...
			<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Material Reception</li>
					</ul><!-- /.breadcrumb -->
			...
			<div class="page-content">
					...
					<div class="well">
						<table>
							<tr>
								<td>&nbsp;DistributionNo : &nbsp;</td>
								<td>&nbsp;<input id="search_disno" placeholder="Distribution No..." style="height: 30px;width:200px" type="text"></td>
								<td>&nbsp;<input type="button" class="btn btn-sm btn-success" id="btnQuery" value="Search" style="margin-left: 2px;"></input>&nbsp;</td>
								<td>&nbsp;<input type="button" class="btn btn-sm btn-info" id="btnReception" value="Reception" style="margin-left: 2px;"></input>&nbsp;</td>
							</tr>
						</table>
					</div>
					...
					<thead><tr>
						...
						<th style="text-align:center;padding-left:0px;padding-right:0px;" width="40px">BYD_NO</th>
						...
						<th style="text-align:center;padding-left:0px;padding-right:0px;" width="30px">Quantity</th>
						...
						<th style="text-align:center;padding-left:0px;padding-right:0px;" width="40px">Reception</th>
						<th style="text-align:center;padding-left:0px;padding-right:0px;" width="50px">ReceptionTime</th>
						</tr>
					</thead>
					<tbody></tbody>
					</table>
	...
	<script type="text/javascript" src="../js/production/materialReception.js"></script>
</html>
