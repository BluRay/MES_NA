		...
		columns: [
		            ...
		            {"title":"Operation","class":"center","data": null,"id":"staff_number",
		            	"render": function ( data, type, row ) {
		                    return "<i class=\"glyphicon glyphicon-search bigger-130 showbus\" title=\"Show Detail\" onclick=\"javascript:window.location = ('displayPlan?version="+row['version'] + "&plan_month="+row['month'] + "&factory_id=" +$("#search_factory").val()+"')\" style='color:blue;cursor: pointer;'></i>&nbsp;";
		                },
		            }
		          ],
	});
